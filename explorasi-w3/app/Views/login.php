...
<body>
  <div class="containers d-flex align-items-center justify-content-center">
    <div class="box-login d-flex align-items-center justify-content-center flex-column">
      <h2 class="text-white mb-3">Welcome to my Website.</h2>
      <form action="/login" method="POST" class="w-100 d-flex align-items-center justify-content-center flex-column gap-2">
        <?= csrf_field(); ?>
        <div class="w-100">
        ...
        <button type="submit" class="btn btn-success mt-3 w-100">Sign In</button>
      </form>
