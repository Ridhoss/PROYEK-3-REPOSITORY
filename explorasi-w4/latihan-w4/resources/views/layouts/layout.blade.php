...
<body>
    <div class="containers">
        ...
        <div class="menu w-100 d-flex align-items-center justify-content-center">
            <a href="/admin/home" class="btn btn-outline-dark">Home</a>
            <a href="/admin/mahasiswa" class="btn btn-outline-dark">Students</a>
            <a href="/admin/course" class="btn btn-outline-dark">Courses</a>
